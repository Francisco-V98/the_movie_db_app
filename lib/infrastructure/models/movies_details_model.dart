...
MoviesDetailModel moviesDetailModelFromJson(String str) => MoviesDetailModel.fromJson(json.decode(str));

String moviesDetailModelToJson(MoviesDetailModel data) => json.encode(data.toJson());
